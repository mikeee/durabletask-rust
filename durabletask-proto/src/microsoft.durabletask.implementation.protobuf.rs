...
pub struct OrchestrationState {
    ...
    pub completed_timestamp: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
pub struct WorkItem {
    ...
    #[prost(oneof = "work_item::Request", tags = "1, 2, 3, 4")]
...
impl ::prost::Name for HealthPing {
    const NAME: &'static str = "HealthPing";
    const PACKAGE: &'static str = "";
    fn full_name() -> ::prost::alloc::string::String {
        "HealthPing".into()
    }
...
pub mod task_hub_sidecar_service_server {
    ...
    #[async_trait]
    pub trait TaskHubSidecarService: std::marker::Send + std::marker::Sync + 'static {
        /// Sends a hello request to the sidecar service.
        async fn hello(
            &self,
    ...
    #[derive(Debug)]
    pub struct TaskHubSidecarServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> TaskHubSidecarServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for TaskHubSidecarServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "TaskHubSidecarService";
    impl<T> tonic::server::NamedService for TaskHubSidecarServiceServer<T> {
